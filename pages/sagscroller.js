...
var sagscroller_constants={
	navpanel: {height:'16px', downarrow:'down.png', opacity:0.6, title:'Go to Next Content', background:'black'},
...
sagscroller.prototype={
	...
	addnavpanel:function(){
		...
		var $navpanel=$('<div class="sliderdesc"><div class="sliderdescbg"></div><div class="sliderdescfg"><div class="sliderdesctext"></div></div></div>')
			...
			.eq(2).css({textAlign:'center', cursor:'pointer', paddingTop:'2px'}).html('<img width="20px" height="20px" src="'+sagscroller_constants.navpanel.downarrow+'"/>').end().end()
